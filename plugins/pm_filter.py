...
async def rename(bot,update):
	...
	await update.message.reply_text("»»——— please enter new file names...",	
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love 💞 MarselDev ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You MarselDev ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/MarselUpdate')
            ],[
            InlineKeyboardButton('🙆🏻 Help 🙎', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
            ],[
            InlineKeyboardButton('MovieChannel', url='https://t.me/MarselUpdate')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You MarselDev ♥️')
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"Marvel Channel", url=f"https://telegram.me/MarvelStudioi")
            ],[
                InlineKeyboardButton(text=f"⚡️ Channel 🦋", url=f"https://t.me/MarselMovie")
...
async def auto_filter(client, msg, spoll=False):
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ Hello`{message.from_user.first_name}` 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ **ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ** !\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝Content Name  : `{search}`\n➟ 👮Requested By : `{message.from_user.first_name}`\n\n༺ @{MAIN_CHANNEL_USRNM} ༻\n\n🦋・‥☆Admin Support☆‥・🦋\n╰┈➤・☆ @{ADMIN_USRNM}\n╰┈➤・☆ @MarselMovie",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("━ • │▌║ Add My Two Your Group ║▌│ • ━", url=f'http://t.me/{temp.U_NAME}?startgroup=true')],[InlineKeyboardButton("✪Channel✪", url=f"https://t.me/MarselMovie"), InlineKeyboardButton("✪Y T ✪", url=f"https://youtube.com/@{LAZY_YT_HANDLE}"), InlineKeyboardButton("✪ Main Ch- ✪", url=f"https://t.me/MarselMovie")],[InlineKeyboardButton("╚»♥️ Thank You ♥️«╝", callback_data="close_data")]]))
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ Movie Channel ⚡", url='https://t.me/MarselMovie'),
        ] 
    )
    if offset != "":
